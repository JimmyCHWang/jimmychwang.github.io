...
const academicProjects = [
    ...
    },
    {
        ...
        children: [
            {
                id: 'ucsc-cse184',
                label: 'CSE184: Japanese Kanji Scraping and Ranking',
                type: 'h5',
                children: null,
                desc: 'A data engineering project that scrapes, analyzes, and ranks Japanese Kanjis for a learning app, with visualization.',
                lang: ['Python'],
                tech: [
                    'Pandas',
                    'Numpy',
            ...
            {
                id: 'ucsc-math181-cse185e',
                label: 'CSE185E/MATH181: A Peek to Cryptography History',
                type: 'h5',
                children: null,
                desc: 'An essay walking through the concept of secure communication, the concept of substitution cipher, substitution cryptanalysis with examples, Vigenere, and a few other common classical ciphers. Used manim engine to create 3Blue1Brown style animations for presentation.',
                lang: ['Python', 'LaTeX'],
                tech: ['Cryptography', 'Substitution', 'Writing', 'manim', 'Security', 'History', 'Mathematics'],
                time: [2020, 2],
            },
        ],
    },
