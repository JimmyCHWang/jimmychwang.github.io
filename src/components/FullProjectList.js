        ...
        children: [
            {
                ...
                type: 'h5',
                children: null,
                desc: 'A web application for online exams. Highlight features include customized grading scripts, reusable question banks, and convenient cloning. Expected to serve 400 students in an exam.',
                lang: ['React', 'TypeScript', 'Go', 'MySQL', 'MongoDB'],
        ...
        children: [
            {
                ...
                type: 'h5',
                children: null,
                desc: 'Developed a PC/Android dual platform room escape game with AIR and ActionScript. Responsible for puzzle implementation, save data management, testing, and debug.',
                lang: ['ActionScript', 'JavaScript'],
                tech: ['ActionScript', 'Steam Frameworks', 'Adobe AIR'],
                time: [2020, 0, null],
            },
            {
                id: 'nings-wing-3-beta-test',
                label: 'Beta Testing Platform',
                type: 'h5',
                children: null,
                desc: 'Built a game registration and beta testing management full stack application using NextJS (TypeScript) + Python FastAPI + MySQL 8. Integrated with the main game application.',
                lang: ['React', 'NextJS', 'TypeScript', 'Python', 'FastAPI', 'MySQL'],
                tech: ['Ant Design', 'Server Side Rendering'],
                time: [2023, 7],
            },
        ],
    },
...
const personalProjects = [
    ...
    },
    {
        ...
        type: 'h5',
        children: null,
        desc: 'Developed a React Native (Android) mobile application that could read and write NFC tag information. Consolidated with AWS pub-sub services for tracking and data analysis.',
        lang: ['TypeScript', 'React'],
        tech: ['React Native', 'NFC', 'Android', 'Storage', 'ReactNativeElements UI', 'React Navigation'],
        time: [2023, 2, 2023, 4],
    },
    {
        ...
        lang: ['JavaScript', 'Vue'],
        tech: ['Express.js', 'Chart.js', 'SQLite'],
        time: [2021, 10],
    },
    {
        id: 'e-dice',
        ...
        type: 'h5',
        children: null,
        desc: 'Launched a tool application responding text commands and sending results to chat servers such as Discord / Tencent QQ.',
        lang: ['JavaScript', 'Python'],
        tech: ['Express.js', 'SQLite', 'Discord API', 'Tencent API', 'HoshinoBot'],
        time: [2020, 7],
    },
];
